					...
					<Flex w="100%" direction="column" align="center">
						...
						<Flex w="100%" align="center" justify="center" px="10%" direction={["column", "row"]}>
							<Flex direction="column" align="center" w={["100%", "50%"]} mb={["5", "0"]}>
								...
								<Text color="rgb(200,200,250)" cursor="pointer" mb="2" onClick={() => window.open("https://twitter.com/solsmahneth?s=21&t=_O59LWK2c3h6KY31ZgkOxw", "_BLANK")}>@tulipmaneth</Text>
								Also known as Tulipman in the community, Tulipman is a UAE based Blockchain developer and NFT consultant
								</Text>
							</Flex>
